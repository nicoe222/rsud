        ...
        <div className="space-y-4">
          ...
          <div className="flex md:flex-row flex-col bg-white border w-full border-gray-200 rounded-lg hover:bg-gray-100 hover:cursor-pointer">
            ...
            <div className=" p-4 space-y-2">
              ...
              <p className="font-normal text-gray-700">
                Bagi Anda yang beragama Islam, kami menyediakan masjid yang
                dapat menampung lebih dari 100 orang.
              </p>
            </div>
          </div>
          <div className="flex md:flex-row flex-col bg-white border w-full border-gray-200 rounded-lg hover:bg-gray-100 hover:cursor-pointer">
            ...
            <div className=" p-4 space-y-2">
              ...
              <p className="font-normal text-gray-700">
                Kami menyediakan fasilitas ATM untuk Anda dalam pengambilan uang
                tunai. Total 6 ATM bank terkemuka Kami sediakan untuk kemudahan
                Anda.
              </p>
            </div>
          </div>
