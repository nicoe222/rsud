      ...
      <div className="px-8 md:px-24 py-8 grid md:grid-cols-3 gap-4">
        ...
        font-extralight text-white z-10 absolute bg-blue-400 dark:bg-slate-600"
          ...
          <div className="px-5 pb-5 space-y-3">
            ...
            <div className="flex items-center hover:text-blue-500 hover:cursor-pointer">
              <p className="text-lg">
                Pelatihan dan workshop penerapan bundles Infeksi Aliran Darah
                (IAD) dan Penatalaksanaan Plebitis
              </p>
            </div>
          </div>
        </div>
        ...
        font-extralight text-white z-10 absolute bg-blue-400 dark:bg-slate-600"
          ...
          <div className="px-5 pb-5 space-y-3">
            ...
            <div className="flex items-center hover:text-blue-500 hover:cursor-pointer">
              <p className="text-lg">
                Peresmian 3 Fasilitas baru Radioterapi , Medical Check Up One
                Stop service & Dental Care
              </p>
            </div>
          </div>
        </div>
        ...
        font-extralight text-white z-10 absolute bg-blue-400 dark:bg-slate-600"
          ...
          <div className="px-5 pb-5 space-y-3">
            ...
            <div className="flex items-center hover:text-blue-500 hover:cursor-pointer">
              <p className="text-lg">
                HARI PELANGGAN NASIONAL 2022 - RSUD Simpang Lima Gumul
                berkomitmen tingkatkan kualitas layanan
              </p>
            </div>
          </div>
        </div>
